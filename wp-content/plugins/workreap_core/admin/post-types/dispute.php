                                    ...
                                    <li class="collapsed">
                                        <div class="wt-dateandmsg">
                                            ...
                                            <div class="wt-actionbtns">
                                                <a href="javascript:;" class="wt-btn wt-msgbtn"><i class="lnr lnr-chevron-up"></i><?php esc_html_e('Messages', 'workreap_core'); ?></a>
                                                <?php if (!empty($project_files)) { ?>
                                                        <a href="javascript:;" data-id="<?php echo esc_attr($comments_ID); ?>" class="wt-btn wt-attachmentbtn wt-download-attachment"><i class="lnr lnr-download"></i><?php esc_html_e('Attachment(s)', 'workreap_core'); ?></a>
                                                <?php } ?>
                                            </div>
                                        </div>
