		...
		public function renderPdfHtml($results){
			...
			if( !empty( $results ) ){
				foreach($results as $result ) { 
					...
					$payrol_title 	= !empty( $payrols_list[$result['payment_method']]['title'] ) ? $payrols_list[$result['payment_method']]['title'] : '';
					...
					if( !empty( $result['payment_method'] ) && $result['payment_method'] === 'paypal' ){
						...
						$paymentdetails	 = '';
						$payrols_list	= !empty( $payrols_list['bacs']['fields'] ) ? $payrols_list['bacs']['fields'] : array();
