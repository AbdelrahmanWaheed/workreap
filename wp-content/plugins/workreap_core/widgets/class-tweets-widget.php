 ...
 * @author ab
 */
if ( !class_exists( 'Workreap_Tweets' ) ) {

	class Workreap_Tweets extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
				'workreap_tweets', // Base ID
				esc_html__( 'Tweets | Workreap', 'workreap_core' ), // Name
				array( 'classname' => 'wt-widgettwitter',
					'description' => esc_html__( 'Show latest tweets.', 'workreap_core' ), ) // Args
			);
		}
...
function workreap_register_workreap_tweets_widgets() {
	register_widget( 'Workreap_Tweets' );
}
