		...
		protected function render() {
													...
													<div class="wt-radioholder">
														<?php 
														  foreach( $searchs as $search ) {
															...
															?>
															<span class="wt-radio">
																<input id="wt-<?php echo esc_attr( $search );?>" data-url="<?php echo esc_url($action_url);?>" data-title="<?php echo esc_attr( $search_title );?>" type="radio" name="searchtype" value="<?php echo esc_attr($search);?>" <?php echo esc_attr($checked);?>>
																<label for="wt-<?php echo esc_attr( $search );?>"><?php echo esc_html( $search_title );?></label>
															</span>
														<?php } ?>
													</div>
			...
			<script type="application/javascript">
				jQuery(document).ready(function () {
					jQuery('#wt-bgworkslider-<?php echo esc_js($flag);?>').owlCarousel({
						items: 				1,
						nav:				false,
