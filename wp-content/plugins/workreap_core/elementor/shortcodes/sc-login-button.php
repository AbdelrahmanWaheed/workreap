					...
					<?php if( !empty( $header_type['gadget'] ) && 
						...
						<div class="wt-loginoption wt-loginoptionvtwo">
							<?php if( !empty( $enable_login_register['enable']['login_signup_type'] ) && $enable_login_register['enable']['login_signup_type'] === 'popup' ){?>
								<a href="javascript:;"  data-toggle="modal" data-target="#loginpopup" class="wt-btn"><?php echo esc_html($button_title);?></a>
							<?php } else if( !empty( $enable_login_register['enable']['login_signup_type'] ) && $enable_login_register['enable']['login_signup_type'] === 'single_step' ){?>
								<a href="javascript:;"  data-toggle="modal" data-target="#loginpopup" class="wt-btn"><?php echo esc_html($button_title);?></a>
							<?php } else {?>
								<a href="javascript:;" id="wt-loginbtn" class="wt-btn wt-loginbtn"><?php echo esc_html($button_title);?></a>
							<?php }?>
						</div>
					<?php }else {?>
						<?php if( !empty( $enable_login_register['enable']['login_signup_type'] ) && $enable_login_register['enable']['login_signup_type'] === 'popup' ){?>
							<a href="javascript:;"  data-toggle="modal" data-target="#loginpopup" class="wt-btn wt-joinnowbtn wt-loginbtn"><?php echo esc_html($button_title);?></a>
						<?php } else if( !empty( $enable_login_register['enable']['login_signup_type'] ) && $enable_login_register['enable']['login_signup_type'] === 'single_step' ){?>
							<a href="javascript:;"  data-toggle="modal" data-target="#loginpopup" class="wt-btn wt-joinnowbtn wt-loginbtn"><?php echo esc_html($button_title);?></a>
						<?php } else {?>
							<a href="javascript:;" id="wt-loginbtn" class="wt-btn wt-joinnowbtn wt-loginbtn"><?php echo esc_html($button_title);?></a>
						<?php }?>
					<?php }?>
