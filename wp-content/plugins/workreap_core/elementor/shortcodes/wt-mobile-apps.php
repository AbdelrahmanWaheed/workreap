							...
							<?php if( ( !empty( $google_image ) && !empty( $play_store_url ) ) || ( !empty( $app_store_image ) && !empty( $app_store_url ) ) ) {?>
								<ul class="wt-appicons">
									<?php if( !empty( $google_image ) && !empty( $play_store_url ) ) {?>
										<li><a href="<?php echo esc_url( $play_store_url );?>"><img src="<?php echo esc_url( $google_image );?>" alt="<?php esc_attr_e('Play store','workreap_core');?>"></a></li>
									<?php }?>
									<?php if( !empty( $app_store_image ) && !empty( $app_store_url ) ) {?>
										<li><a href="<?php echo esc_url( $app_store_url );?>"><img src="<?php echo esc_url( $app_store_image );?>" alt="<?php esc_attr_e('App store','workreap_core');?>"></a></li>
									<?php }?>
								</ul>
							<?php }?>
						</div>
