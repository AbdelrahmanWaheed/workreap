...
if( !class_exists('Workreap_Working_Process') ){
	class Workreap_Working_Process extends Widget_Base {
		...
		protected function render() {
			...
			$text_align  = !empty($settings['text_align'] && $settings['text_align'] == 'left' ) ? esc_html__('float-left', 'workreap_core') : esc_html__('float-right', 'workreap_core');
			$image_align 	= !empty($settings['image_align'] && $settings['image_align'] == 'left' ) ? esc_html__('float-left', 'workreap_core') : esc_html__('float-right', 'workreap_core');
