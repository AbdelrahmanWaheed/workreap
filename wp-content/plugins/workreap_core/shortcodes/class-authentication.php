        ...
        public function shortCodeCallBack($atts) {
            ...
            if (!is_user_logged_in()) {               
				...
				if( isset( $verify_user ) && $verify_user === 'verified' ){
					...
					if( !empty( $verified_key ) && $verified_key === 'no' ){
						$this->workreap_do_verify_registration();   
					}else if( !empty( $verified_key ) && $verified_key === 'yes' && $step == 4 ){
						do_action( 'workreap_registration_step_four' );
					} else {
                                ...
                                <div class="wt-registerformhold">
                                    <div class="tab-content wt-registertabcontent">
                                        <div class="tab-pane active step-three-contents" id="three">
                                            <?php do_action( 'workreap_registration_step_three' ); ?>
                                        </div>                                            
                                    </div>                                        
                                </div>
                            </div>
                                ...
                                <div class="wt-registerformhold">
                                    <div class="tab-content wt-registertabcontent">
                                        ...
                                        <?php } elseif( $step == 3 ){ ?>                          
                                            <?php if( is_user_logged_in() ){ ?>
                                                <?php if( isset( $verify_user ) && $verify_user === 'none' ){?>
                                                	<?php do_action( 'workreap_registration_step_four' ); ?>
                                                <?php }else{?>
                                                <div class="tab-pane active step-three-contents" id="three">
                                                    <?php do_action( 'workreap_registration_step_three' ); ?>
                                    ...
                                    <?php if( !is_user_logged_in() ){ ?>
                                        <div class="wt-registerformfooter">
                                            <span><?php esc_html_e('Already Have an Account?', 'workreap_core' ); ?>&nbsp;<a class="wt-loginfor-offer wt-loginbtn register-loginpop" href="javascript:;"><?php esc_html_e('Login Now', 'workreap_core'); ?></a></span>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
