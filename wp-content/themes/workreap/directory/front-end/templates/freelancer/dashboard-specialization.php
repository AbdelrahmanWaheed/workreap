		...
		<div class="wt-formtheme wt-userform wt-experience-form">
			<fieldset>
				...
				<div class="form-group wt-btnarea">
					<a href="javascript:;" class="wt-btn wt-add-specialization-box" data-display_type="<?php echo esc_attr($display_type);?>"><?php esc_html_e('Add Specialization', 'workreap'); ?></a>
				</div>
			</fieldset>
		</div>
