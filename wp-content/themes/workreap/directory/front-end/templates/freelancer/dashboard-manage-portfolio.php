								...
								<tr>
											...
											<fieldset>
												<div class="form-group">
													...
													<?php }else{?>
														...
														<a href="javascript:;" data-id="<?php echo intval($post->ID);?>" class="wt-searchgbtn wt-service-status"><i class="fa fa-check"></i></a>
													<?php }?>
												</div>
											</fieldset>
										</form>
									...
									<td>
										<div class="wt-actionbtn">
											...
											<?php } ?>
											<a href="<?php Workreap_Profile_Menu::workreap_profile_menu_link('portfolio', $user_identity, '','edit',$post->ID); ?>" class="wt-addinfo">
												<i class="lnr lnr-pencil"></i>
											</a>
											<a href="javascript:;" data-id="<?php echo intval( $post->ID );?>" class="wt-deleteinfo wt-delete-portfolio"><i class="lnr lnr-trash"></i></a>
										</div>
									</td>
								</tr>
							<?php
