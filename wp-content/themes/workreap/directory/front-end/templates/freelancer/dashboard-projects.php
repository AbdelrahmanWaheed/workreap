...
<div class="wt-addprojectsholder">
	<div class="wt-tabscontenttitle wt-addnew">
		...
		<span class="wt-add-project"><a href="javascript:;"><?php esc_html_e('+ Add project', 'workreap'); ?></a></span>
	</div>
				...
				<div class="wt-accordioninnertitle">
					...
					<div class="wt-projecttitle collapsed" data-toggle="collapse" data-target="#innertitle<?php echo esc_attr( $count_rand ); ?>">						
						...
						<h3>
							...
							<span class="head-sub-title"><?php echo esc_attr( $link ); ?></span>
						</h3>
					</div>
					<div class="wt-rightarea">
						<a href="javascript:;" class="wt-addinfo wt-skillsaddinfo" data-toggle="collapse" data-target="#innertitle<?php echo esc_attr( $count_rand ); ?>"><i class="lnr lnr-pencil"></i></a>
								...
								<?php if( !empty( $image ) ){ ?>
									<ul class="wt-attachfile">
										<li class="wt-doc-parent">
											...
											<em><?php esc_html_e('File size:', 'workreap'); ?> <?php echo esc_html( size_format($file_size, 2) ); ?><a href="javascript:;" class="wt-remove-award-image lnr lnr-cross"></a></em>			
...
<script type="text/template" id="tmpl-load-project-image">
	<ul class="wt-attachfile">
		<li class="wt-uploading award-new-item wt-doc-parent" id="thumb-{{data.id}}">
			...
			<span>{{data.name}}</span>
			<em><?php esc_html_e('File size:', 'workreap'); ?> {{data.size}}<a href="javascript:;" class="lnr lnr-cross wt-remove-award-image"></a></em>
...
<li id="wt-award-{{data.counter}}" data-id="{{data.counter}}" class="wt-placehoder-img">
	<div class="wt-accordioninnertitle">
		...
		<div class="wt-projecttitle collapsed" data-toggle="collapse" data-target="#innertitle-{{data.counter}}">
			...
			<h3><span class="head-title"><?php esc_html_e('Project Title Here', 'workreap'); ?></span><span class="head-sub-title"><?php esc_html_e('www.test.com', 'workreap'); ?></span></h3>
		</div>
		<div class="wt-rightarea">
			<a href="javascript:;" class="wt-addinfo wt-skillsaddinfo" data-toggle="collapse" data-target="#innertitle-{{data.counter}}"><i class="lnr lnr-pencil"></i></a>
			<a href="javascript:;" class="wt-deleteinfo wt-delete-data"><i class="lnr lnr-trash"></i></a>
		</div>
	</div>
