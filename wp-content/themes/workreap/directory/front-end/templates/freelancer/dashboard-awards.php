...
<div class="wt-awardsdataholder wt-tabsinfo">
	<div class="wt-tabscontenttitle wt-addnew">
		...
		<span class="wt-add-award"><a href="javascript:;"><?php esc_html_e('+ Add Award', 'workreap'); ?></a></span>
	</div>
	<ul class="wt-experienceaccordion accordion" data-id="<?php echo esc_url( $default_img ); ?>" id="awardssortable">
		...
		if( !empty( $awards ) && is_array($awards) ) {
			...
			foreach ($awards as $key => $value) {
				...
				$image_url 	= !empty( $image ) ? wp_get_attachment_image_src( $image['attachment_id'], 'workreap_latest_articles_widget', true ) : '';				
				...
				<li id="wt-award-<?php echo esc_attr( $rand ); ?>" data-id="<?php echo esc_attr( $rand ); ?>" class="wt-placehoder-img">
					<div class="wt-accordioninnertitle">
						...
						<div class="wt-rightarea">
							<a href="javascript:;" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitle1" data-toggle="collapse" data-target="#innertitle<?php echo esc_attr( $rand ); ?>" aria-expanded="true"><i class="lnr lnr-pencil"></i></a>
