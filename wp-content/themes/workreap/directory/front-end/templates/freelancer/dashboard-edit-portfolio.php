		...
		<?php 
			if (intval($url_identity) === intval($post_author)) {
				...
				while ($query->have_posts()) : $query->the_post();
					...
					$tags	= wp_get_post_terms($post->ID, 'portfolio_tags');
					?>
					<form class="post-portfolio-form wt-haslayout">
							...
							<div class="wt-dashboardboxcontent">
										...
										<div class="form-group">
											<select name="tags[]" class="form-control portfolio-tags" multiple="multiple">
												...
												foreach($tags as $key=> $tag){?>
													<option selected value="<?php echo esc_html($tag->slug);?>"><?php echo esc_html($tag->name);?></option>
												<?php }}?>
											</select>
										</div>
									</div>
								...
								<div class="wt-videosdataholder wt-tabsinfo wt-awardsholder" id="wt-videos">
									<div class="wt-tabscontenttitle wt-addnew">
										...
										<span class="wt-add-portfolio-video"><a href="javascript:;"><?php esc_html_e('+ Add Video URL', 'workreap'); ?></a></span>
									</div>
						...
						<div class="wt-updatall">
							...
							<a class="wt-btn wt-post-portfolio" data-id="<?php echo intval($edit_id);?>" data-type="update" href="javascript:;"><?php esc_html_e('Save &amp; Update', 'workreap'); ?></a>
						</div>
					</form>
				<?php 
				endwhile;
