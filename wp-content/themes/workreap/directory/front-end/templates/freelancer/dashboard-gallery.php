							...
							<li class="wt-uploadingholder wt-companyimg-user">
								<div class="wt-uploadingbox">
									...
									<div class="wt-uploadingbar">
										...
										<em><?php esc_html_e('File size:', 'workreap'); ?> <?php echo esc_html( size_format($banner_file_size, 2) ); ?><a href="javascript:;" class="wt-remove-gallery-image lnr lnr-cross"></a></em>
									</div>	
	...
	<li class="wt-uploadingholder wt-companyimg-user" id="thumb-{{data.id}}">
		<div class="wt-uploadingbox">
			...
			<div class="wt-uploadingbar wt-uploading">
				...
				<span>{{data.name}}</span>
				<em><?php esc_html_e('File size:', 'workreap'); ?> {{data.size}}<a href="javascript:;" class="wt-remove-gallery-image lnr lnr-cross"></a></em>	
			</div>	
		</div>
	</li>
</script>
