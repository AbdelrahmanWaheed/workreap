	...
	<div class="wt-haslayout wt-post-job-wrap">
		<form class="post-service-form wt-haslayout">
			...
			<div class="wt-updatall">
				...
				<a class="wt-btn wt-post-addons-service" data-id="<?php echo intval( $post_id );?>" data-type="<?php echo esc_attr( $action );?>" href="javascript:;"><?php esc_html_e('Save &amp; Update', 'workreap'); ?></a>
			</div>
		</form>	
	</div>
</div>