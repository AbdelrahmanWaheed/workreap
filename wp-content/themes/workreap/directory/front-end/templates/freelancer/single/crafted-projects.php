	...
	<div class="wt-craftedprojects">
		...
		<?php 
			...
			foreach( $projects as $key => $item ){ 
				...
				$item_show	= !empty($count_itme) && intval($count_itme) > $cr_project_limit ? 'style="display: none;"' : "";
			?>
			...
			<?php 
				...
				<div class="wt-btnarea">
					<a href="javascript:;" class="wt-btn wt-loadmore-crprojects"><?php esc_html_e('Load More','workreap');?></a>
				</div>
			<?php }?>
		</div>
	</div>
