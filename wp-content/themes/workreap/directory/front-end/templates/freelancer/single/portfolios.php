	...
	<?php 
		if ($query->have_posts()) {
			...
			while ($query->have_posts()) : $query->the_post();
				...
				$image_url	= get_the_post_thumbnail_url($post_id, 'workreap_portfolio_freelancer');
			...
			endwhile;
				...
				<div class="wt-btnarea">
					<a href="javascript:;" class="wt-btn wt-loadmore-portfolios"><?php esc_html_e('Load More', 'workreap');?></a>
				</div>
		<?php }}?>
	</div>
</div>