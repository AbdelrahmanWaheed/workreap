				...
				while ($query->have_posts()) : $query->the_post();
					...
					<form class="post-service-form wt-haslayout">
									...
									<div class="wt-formtheme wt-userform wt-userformvtwo">
										<fieldset>
											<div class="form-group form-group-half wt-formwithlabel">
												<input type="text" name="service[title]" value="<?php the_title();?>" class="form-control" placeholder="<?php esc_attr_e('Service Title','workreap');?>">
											</div>
											<div class="form-group form-group-half wt-formwithlabel">
											...
											<div class="form-group form-group-half wt-formwithlabel job-cost-input">
												<input type="text" name="service[price]" value="<?php echo intval($db_price);?>" placeholder="<?php esc_attr_e('Service price','workreap');?>">
											</div>
											<div class="form-group form-group-half wt-formwithlabel">
												<span class="wt-selects">
												...
												<ul class="wt-attachfile uploaded-placeholder">
													...
													if( !empty( $db_docs ) ){
														...
														<li class="wt-doc-parent" id="thumb-<?php echo intval($attachment_id);?>">
															<span><?php echo esc_attr($document_name);?></span>
						...
						<div class="wt-updatall">
							...
							<a class="wt-btn wt-post-service" data-id="<?php echo intval($edit_id);?>" data-type="update" href="javascript:;"><?php esc_html_e('Save &amp; Update', 'workreap'); ?></a>
						</div>
					</form>
				<?php 
					endwhile;
