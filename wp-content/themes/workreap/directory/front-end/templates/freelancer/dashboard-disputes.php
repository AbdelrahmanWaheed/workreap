			...
			<div class="wt-modalbody modal-body">
				<form class="wt-formtheme wt-disputeform wt-formfeedback">
					<fieldset>
						...
						<div class="form-group">
							<textarea class="form-control" name="dispute[description]" placeholder="<?php esc_attr_e('Add description','workreap');?>*"></textarea>
						</div>
						<div class="form-group wt-btnarea">
							<a class="wt-btn wt-add-dispute" href="javascript:;">
