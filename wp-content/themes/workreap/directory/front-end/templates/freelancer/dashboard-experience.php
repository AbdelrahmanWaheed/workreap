...
<div class="wt-userexperience wt-tabsinfo">
	<div class="wt-tabscontenttitle wt-addnew">
		...
		<span class="wt-add-experience"><a href="javascript:;"><?php esc_html_e('+ Add Experience', 'workreap'); ?></a></span>
	</div>
				...
				<li class="dateinit-<?php echo esc_attr( $counter ); ?>">
					<div class="wt-accordioninnertitle">
						...
						<div class="wt-rightarea">
							<a href="javascript:;" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitle" data-toggle="collapse" data-target="#innertitle<?php echo esc_attr( $counter ); ?>" aria-expanded="false"><i class="lnr lnr-pencil"></i></a>
						...
						<div class="wt-formtheme wt-userform">
							<fieldset>
								<div class="form-group form-group-half">
									<input type="text" name="settings[experience][<?php echo esc_attr( $counter ); ?>][title]" class="wt-head-input form-control" value="<?php echo esc_attr( $title ); ?>" placeholder="<?php esc_attr_e('Your Job Title', 'workreap'); ?>">
								</div>
								<div class="form-group form-group-half">
								...
								<div class="form-group">
									<textarea name="settings[experience][<?php echo esc_attr( $counter ); ?>][details]" class="form-control" placeholder="<?php esc_attr_e('Your Job Description', 'workreap' ); ?>"><?php echo esc_html( $description ); ?></textarea>
								</div>
								<div class="form-group">
...
<li class="dateinit-{{data.counter}}">
	<div class="wt-accordioninnertitle">
		<a href="javascript:;" class="handle"><i class="fa fa-arrows-alt"></i></a>
		<span id="accordioninnertitle" data-toggle="collapse" data-target="#innertitle{{data.counter}}"><span class="wt-head-title"><?php esc_html_e('Job title', 'workreap'); ?></span>&nbsp;<em><?php esc_html_e('(Start Date - End Date)', 'workreap'); ?></em></span>
		<div class="wt-rightarea">
			<a href="javascript:;" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitle" data-toggle="collapse" data-target="#innertitle{{data.counter}}" aria-expanded="true"><i class="lnr lnr-pencil"></i></a>
			<a href="javascript:;" class="wt-deleteinfo wt-delete-data"><i class="lnr lnr-trash"></i></a>
		</div>
	</div>
	<div class="wt-collapseexp collapse show" id="innertitle{{data.counter}}" aria-labelledby="accordioninnertitle" data-parent="#accordion">
		<div class="wt-formtheme wt-userform">
			<fieldset>
				<div class="form-group form-group-half">
					<input type="text" name="settings[experience][{{data.counter}}][title]" class="wt-head-input form-control" placeholder="<?php esc_attr_e('Job Title', 'workreap'); ?>">
				</div>
				<div class="form-group form-group-half">
				...
				<div class="form-group">
					<textarea name="settings[experience][{{data.counter}}][details]" class="form-control" placeholder="<?php esc_attr_e('Your Job Description', 'workreap'); ?>"></textarea>
				</div>
				<div class="form-group">
					<span><?php esc_html_e('* Leave ending date empty if its your current job', 'workreap'); ?></span>
				</div>
