...
<div class="wt-skills">
	<div class="wt-tabscontenttitle">
		<h2><?php esc_html_e('Industrial experience', 'workreap'); ?></h2>
	</div>
		...
		<div class="wt-formtheme wt-userform wt-experience-form">
			<fieldset>
				...
				<div class="form-group wt-btnarea">
					<a href="javascript:;" class="wt-btn wt-add-industrial-exp-box" data-display_type="<?php echo esc_attr($display_type);?>"><?php esc_html_e('Add industrial experience', 'workreap'); ?></a>
				</div>
			</fieldset>
		</div>
