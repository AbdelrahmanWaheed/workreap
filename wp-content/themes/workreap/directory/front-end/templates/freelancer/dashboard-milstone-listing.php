									...
									<?php } else{ ?>
										<div class="wt-milestonebtn wt-flexbox">
											<?php if( !empty($proposal_status)  && $proposal_status ==='pending' && $project_status ==='publish') { ?>
												<a href="javascript:;" class="wt-btn wt-milstone-request-approved wt-bg-green" data-status="approved" data-id="<?php echo intval($proposal_id);?>"><?php esc_html_e('Accept','workreap');?></a>
												<a href="javascript:;" class="wt-btn" data-toggle="modal" data-target="#wt-cancelledfeedback"><?php esc_html_e('Decline','workreap');?></a>
											<?php } ?>
										</div>
									<?php } ?>
					...
					<div class="wt-rcvproposalholder wt-hiredfreelancer">
						...
						<?php 
							while ($query->have_posts()) : $query->the_post();
								...
								$milstone_due_date	= !empty($milstone_due_date) ? date($date_format, strtotime($milstone_due_date)) : '';
				...
				<form class="wt-formtheme wt-formfeedback-cancelled wt-formfeedback">
					<fieldset>
						...
						<div class="form-group wt-btnarea">
							<a class="wt-btn cancelled-btn-milestone" data-proposal-id="<?php echo intval($proposal_id);?>" href="javascript:;">
