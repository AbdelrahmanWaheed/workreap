	...
	<div class="wt-personalskillshold tab-pane active fade show">
		<div class="wt-yourdetails">
			<div class="wt-tabscontenttitle wt-addnew">
				<h2><?php esc_html_e('Saved Services','workreap');?></h2>
				<?php if( $query->have_posts() ) { ?>
					<a href="javascript:;" data-post-id="<?php echo intval($post_id);?>" data-itme-type="_saved_services" class="wt-clicksave wt-clickremoveall">
			...
			<div class="wt-dashboradsaveitem">
				<div class="wt-dashboardboxcontent wt-categoriescontentholder">
										...
										<tr>
											...
											<td>
												<div class="wt-actionbtn">
													<a href="javascript:;" data-post-id="<?php echo intval($post_id);?>" data-item-id="<?php echo intval($post->ID);?>" data-itme-type="_saved_services"  class="wt-deleteinfo wt-clickremove"><i class="lnr lnr-trash"></i></a>
					...
					<?php
							...
							do_action('workreap_empty_records_html','wt-empty-projects',esc_html__( 'You have no service yet.', 'workreap' ));
						}
