...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-right">
	<div class="wt-dashboardbox wt-dashboardinvocies disputes-header">
		<div class="wt-dashboardboxtitle wt-addnew">
			...
			<span><a href="javascript:;" data-toggle="modal" data-target=".wt-dispute-form"><?php esc_html_e( '+ Create Disputes', 'workreap' ); ?></a></span>
		</div>
								...
								<tr>
									...
									<td>
										<div class="wt-actionbtn">
											<a href="javascript:;" class="wt-viewinfo viewinfo-dispute"  data-id="<?php echo intval( $post->ID );?>"><i class="lnr lnr-eye"></i></a>
											<!-- <a href="javascript:;" data-id="<?php //echo intval( $post->ID );?>" class="wt-deleteinfo wt-delete-dispute"><i class="lnr lnr-trash"></i></a> -->
										</div>
									</td>
								</tr>
							<?php
