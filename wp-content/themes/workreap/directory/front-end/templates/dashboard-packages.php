...
<div class="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
	<div class="wt-dashboardbox wt-packages">
		<div class="wt-dashboardboxtitle">
			<h2><?php esc_html_e('Packages','workreap');?></h2>
		</div>
		<?php 
						...
						while ( $loop->have_posts() ) : $loop->the_post();
							...
							<div class="wt-package wt-baiscpackage">
								...
								<div class="wt-packagecontent">
									...
									<a class="wt-btn renew-package" data-key="<?php echo intval($post_id);?>" href="javascript:;"><span><?php esc_html_e('Buy Now','workreap');?></span></a>
								</div>
							</div>
						<?php
					endwhile;
