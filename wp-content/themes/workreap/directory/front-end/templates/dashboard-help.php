						...
						foreach ( $faqs as $faq ) {
							...
							<li class="faq-search">
								<div class="wt-accordiontitle collapsed" id="headingtwo-<?php echo intval($count);?>" data-toggle="collapse" data-target="#collapsetwo-<?php echo intval($count);?>">
									...
									<div class="wt-accordiondetails collapse" id="collapsetwo-<?php echo intval($count);?>" aria-labelledby="headingtwo-<?php echo intval($count);?>">
										<div class="wt-title">
			...
			<form class="wt-formtheme wt-userform wt-faqform">
				<fieldset>
					<div class="form-group">
						<span class="wt-select">
							<select name="query_type" class="query_type">
								<option value="" disabled=""><?php esc_html_e("Select query type","workreap");?></option>
								<?php 
					...
					<div class="form-group form-group-half wt-btnarea">
						<a href="javascript:;" class="wt-btn faq_submit"><?php esc_html_e("Submit","workreap");?></a>
					</div>
				</fieldset>
			</form>
		</div>
