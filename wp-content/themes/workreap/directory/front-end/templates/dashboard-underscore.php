	...
	<div class="wt-iconbox">
		<?php if( apply_filters('workreap_chat_window_floating', 'disable') === 'enable' ){?>
			<div class="wt-fileoption">
				<a href="javascript:;" class="wt-fileoption-icon"></i>
		...
		<?php }?>
		<a href="javascript:;" class="wt-btnsendmsg wt-send" data-status="unread" data-receiver_id="{{data.receiver_id}}"><?php esc_html_e('Send', 'workreap'); ?></a>
	</div>
</div>
</script>
	...
	<div class="wt-description">
		...
		<div class="wt-messagesfile">
			<div class="wt-messagescontent">
				...
				<div class="wt-messagesfile__title">
					<a href="<?php echo esc_url($upload_dir_path."/chat_attachments/"); ?>{{element.chat_filename}}" target="_blank">{{element.chat_filename}}</a>
					<em>file size: {{element.chat_filesize}}</em>
				</div>
...
<div class="wt-messageslink">
	<div class="wt-messagescontent">
		<figure class="wt-meassagesfig">
			...
			<a target="_blank" href="{{data.attachment}}"><i class="ti-share"></i>Top 10 Life Hacks By Alley backyard</a>
		</figure>
	</div>
</div>
</script>