		...
		<div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
			<div class="wt-dashboardtabs">
				<ul class="wt-tabstitle nav navbar-nav">
					...
					<li class="nav-item"><a class="<?php echo esc_attr( $mode === 'password' ? 'active' : ''); ?>"  href="<?php Workreap_Profile_Menu::workreap_profile_menu_link('account-settings', $user_identity,false,'password'); ?>"><?php esc_html_e('Password','workreap');?></a></li>
					<li class="nav-item"><a class="<?php echo esc_attr( $mode === 'emails' ? 'active' : ''); ?>"  href="<?php Workreap_Profile_Menu::workreap_profile_menu_link('account-settings', $user_identity,false,'emails'); ?>"><?php esc_html_e('Email Notifications','workreap');?></a></li>
					<li class="nav-item"><a class="<?php echo esc_attr( $mode === 'delete' ? 'active' : ''); ?>"  href="<?php Workreap_Profile_Menu::workreap_profile_menu_link('account-settings', $user_identity,false,'delete'); ?>"><?php esc_html_e('Delete Account','workreap');?></a></li>
				</ul>
			</div>
