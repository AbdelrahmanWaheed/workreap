	...
	<div class="wt-personalskillshold tab-pane active fade show">
		<div class="wt-yourdetails">
			<div class="wt-tabscontenttitle wt-addnew">
				<h2><?php esc_html_e('Saved Jobs','workreap');?></h2>
				<?php if( $query->have_posts() ) { ?>
					<a href="javascript:;" data-post-id="<?php echo intval($post_id);?>" data-itme-type="_saved_projects" class="wt-clicksave wt-clickremoveall">
			...
			<div class="wt-dashboradsaveitem <?php echo esc_attr( $emptyClass );?>">
				<?php
					if( $query->have_posts() ){
						...
						do_action('workreap_empty_records_html','wt-empty-saved',esc_html__( 'You have no job in your favorite list.', 'workreap' ));
					}
				?>								
			</div>
			<?php
