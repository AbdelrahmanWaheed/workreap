...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
	<div class="wt-dashboardbox">
		...
		<div class="wt-dashboardboxcontent wt-jobdetailsholder history-addons">
			<?php do_action('workreap_service_listing_basic', $service_id ,'wt-jobservice-details','show_details'); ?>
									...
									<form class="wt-formtheme wt-formsearch">
										<fieldset>
											<div class="form-group">
														...
														<?php 
															if( !empty( $job_statuses ) ) {
																foreach( $job_statuses as $key=> $status_v ){
																	?>
																	<option data-proposal-id="<?php echo intval($edit_id);?>" value="<?php echo esc_attr($key);?>"><?php echo esc_attr($status_v);?></option>
																	<?php 
																}
															}
														?>
												...
												<a href="javascript:;" class="wt-searchgbtn" data-toggle="modal" data-target="#wt-projectmodalbox" id="btn-change-status"><i class="fa fa-check"></i></a>
											</div>
										</fieldset>
									</form>												
								</div>
					...
					<form class="wt-formtheme wt-formfeedback-cancelled wt-formfeedback">
						<fieldset>
							...
							<div class="form-group wt-btnarea">
								<a class="wt-btn cancelled-service-btn" data-service-id="<?php echo intval($edit_id);?>" href="javascript:;">
				...
				<div class="wt-modalbody modal-body">
					<form class="wt-formtheme wt-formfeedback-complete wt-formfeedback">
						<fieldset>
							...
							<?php } ?>
							<div class="form-group wt-btnarea">
								<a class="wt-btn compelete-service-btn" data-service-id="<?php echo intval($edit_id);?>" href="javascript:;">
									<?php esc_html_e('Send Feedback','workreap');?>
								</a>
							</div>
						</fieldset>
