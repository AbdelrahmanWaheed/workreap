...
<div class="wt-addprojectsholder wt-likefreelan">
	<div class="wt-tabscontenttitle wt-addnew">
		<h2><?php esc_html_e('Liked Freelancers','workreap');?></h2>
		<?php if( $query->have_posts() ) { ?>
			<a href="javascript:;" data-post-id="<?php echo intval($post_id);?>" data-itme-type="_saved_freelancers" class="wt-clicksave wt-clickremoveall">
	...
	<?php
		if( $query->have_posts() ){
			...
			do_action('workreap_empty_records_html','wt-empty-saved',esc_html__( 'You have no freelancers in your favorite list.', 'workreap' ));
		}
	?>
	</div>
	<?php
