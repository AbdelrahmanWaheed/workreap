	...
	<div class="wt-dashboardbox wt-dashboardservcies">
		...
		<div class="wt-dashboardboxcontent wt-categoriescontentholder">
			...
			<table class="wt-tablecategories wt-tableservice">
				<thead>
					<tr>
						<th><?php esc_html_e('Service Title','workreap');?></th>
				...
				<tbody>
					<?php 
						...
						?>
							<tr>
								<td>
									<?php do_action('workreap_service_listing_basic', $service_id ); ?>
								</td>
								<td>
									<?php do_action('workreap_service_freelancer_html', $service_author ); ?>
								</td>
								<td>
									<span class="bt-content">
										<div class="wt-actionbtn">
											<a href="javascript:;" class="wt-viewinfo wt-btnhistory wt-reasonbtn wt-service-reason" data-id="<?php echo intval($post->ID);?>"><?php esc_html_e('Show Reason','workreap');?></a>
										</div>
									</span>
								</td>
								<td>
