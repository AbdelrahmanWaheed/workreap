...
<form class="wt-formtheme wt-userform wt-save-account-settings">
	<div class="wt-securitysettings wt-tabsinfo wt-delete-account wt-haslayout">
		...
		<div class="wt-settingscontent">
			<div class="wt-description">
				<p><?php esc_html_e('If searchable option will be disabled then your profile will not show in the search result. To hide your profile all over the site you can disable your profile temporarily','workreap');?></p>
			</div>
	...
	<div class="form-group form-group-half wt-btnarea">
		...
		<a href="javascript:;" class="wt-btn save-account-settings"><?php esc_html_e('Save Account Settings','workreap');?></a>
	</div>
</form>
