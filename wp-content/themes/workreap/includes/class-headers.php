...
if (!class_exists('Workreap_Prepare_Headers')) {
    ...
    class Workreap_Prepare_Headers {
        ...
        function __construct() {
			...
			add_action('workreap_demo_preview', array(&$this, 'workreap_demo_preview'));
        ...
        public function workreap_app_available() {
            ...
            if ( !empty( $app_available['gadget'] ) && $app_available['gadget'] === 'enable' && $app_available['enable']['link'] ) {?>
               <a target="_blank" class="wt-appavailable" href="<?php echo esc_url($app_available['enable']['link']);?>">
                    <img class="bubbleicon" src="<?php echo get_template_directory_uri(); ?>/images/bubble.png" alt="<?php esc_attr_e('App Available','workreap');?>">
                    <img class="android-logo" src="<?php echo get_template_directory_uri(); ?>/images/android-logo.png" alt="<?php esc_attr_e('App Available','workreap');?>">
                </a>
               <?php
            }
			echo ob_get_clean();
         ...
         * @author amentotech
         */
        public function workreap_demo_preview() {
				...
				<div id="wt-demo-sidebar" class="wt-demo-sidebar">
					...
					<div id="wt-verticalscrollbar-demos" class="wt-verticalscrollbar">
						<div class="wt-demo-holder">
							<a target="_blank" href="http://amentotech.com/projects/prodesk">
								<figure class="wt-demo-img">
									<img src="<?php echo get_template_directory_uri();?>/images/demo-img/img-06.jpg" alt="<?php esc_attr_e('demos','workreap');?>">
									<figcaption>
										<div class="wt-demo-tags">
											<span class="wt-demo-new"><?php esc_html_e('New','workreap');?></span>
											<span class="wt-demo-populor"><?php esc_html_e('Pro','workreap');?></span>
										</div>
									</figcaption>
								</figure>
							</a>
							<a target="_blank" href="http://amentotech.com/projects/prodesk/home-page-four/">
								<figure class="wt-demo-img">
									<img src="<?php echo get_template_directory_uri();?>/images/demo-img/img-07.jpg" alt="<?php esc_attr_e('demos','workreap');?>">
									<figcaption>
										<div class="wt-demo-tags">
											<span class="wt-demo-new"><?php esc_html_e('New','workreap');?></span>
											<span class="wt-demo-populor"><?php esc_html_e('Pro','workreap');?></span>
							...
							<a target="_blank" href="http://amentotech.com/projects/wpworkreap/">
								<figure class="wt-demo-img">
									<img src="<?php echo get_template_directory_uri();?>/images/demo-img/img-01.jpg" alt="<?php esc_attr_e('demos','workreap');?>">
									<figcaption>
										<div class="wt-demo-tags">
											<span class="wt-demo-new"><?php esc_html_e('New','workreap');?></span>
										</div>
							...
							<a target="_blank" href="http://amentotech.com/projects/elementor">
								<figure class="wt-demo-img">
									<img src="<?php echo get_template_directory_uri();?>/images/demo-img/img-02.jpg" alt="<?php esc_attr_e('demos','workreap');?>">
									<figcaption>
										<div class="wt-demo-tags">
											<span class="wt-demo-new"><?php esc_html_e('Elementor Page Builder','workreap');?></span>
											<span class="wt-demo-populor"><?php esc_html_e('Popular','workreap');?></span>
										</div>
									</figcaption>
								</figure>
							</a>
							<a href="http://amentotech.com/projects/elementor/home-page-three/">
								<figure class="wt-demo-img">
									<img src="<?php echo get_template_directory_uri();?>/images/demo-img/img-03.jpg" alt="<?php esc_attr_e('demos','workreap');?>">
									<figcaption>
										<div class="wt-demo-tags">
											<span class="wt-demo-populor"><?php esc_html_e('New Design','workreap');?></span>
										</div>
									</figcaption>
								</figure>
							</a>
					...
					<div class="wt-demo-content">
						<div class="wt-demo-heading">
							<h4><?php esc_html_e('Outstanding Demos','workreap');?></h4>
							<p><?php esc_html_e('With easy','workreap');?><em> <?php esc_html_e('ONE CLICK INSTALL','workreap');?></em> <?php esc_html_e('and fully customizable options, our demos are the best start you\'ll ever get!!','workreap');?></p>
							<div class="wt-demo-btns">
								<a target="_blank" href="https://themeforest.net/item/workreap-freelance-marketplace-wordpress-theme/23712454?s_rank=3" class="wt-demo-btn"><?php esc_html_e('Buy Now','workreap');?></a>
							</div>
						</div>
					</div>
				</div>
                    ...
                    if ( isset($preloader['enable']['preloader']['gadget']) && $preloader['enable']['preloader']['gadget'] === 'default' ) {?>
                        ...
                        <div class="preloader-outer">
                            <div class="preloader-customloader">
                                <img width="100" src="<?php echo esc_url($preloader['enable']['preloader']['custom']['loader']['url']); ?>" alt="<?php esc_attr_e('loader', 'workreap'); ?>" />
                            </div>
                        </div>
                        <?php
                    }
					...
					<div class="wt-modalcontentvtwo modal-content">
						...
						<div class="modal-body">
								...
								<form class="wt-formtheme wt-formlogin do-login-form">
									<fieldset>
										<div class="form-group">
											<input type="text" name="username" value="" class="form-control" placeholder="<?php esc_attr_e('Your Email*','workreap');?>" required="">
										</div>
										<div class="form-group">
								...
								if (  ( isset($enable_google_connect) && $enable_google_connect === 'enable' ) 
								   ...
								   || ( isset($enable_linkedin_connect) && $enable_linkedin_connect === 'enable' ) 
									...
									<div class="wt-loginicon">
										<ul>
											<?php if (  isset($enable_facebook_connect) && $enable_facebook_connect === 'enable' ) {?><li class="wt-facebook"><a href="javascript:;" class="sp-fb-connect"><i class="fa fa-facebook-f"></i><?php esc_html_e('Facebook','workreap');?></a></li><?php }?>
											<?php if (  isset($enable_google_connect) && $enable_google_connect === 'enable' ) {?><li class="wt-googleplus"><a href="javascript:;" class="" id="wt-gconnect"><i class="fa fa-google"></i><?php esc_html_e('Google','workreap');?></a></li><?php }?>
							...
							<form class="wt-formtheme wt-loginform do-forgot-password-form wt-hide-form">
								<div class="form-group">
									<input type="email" name="email" class="form-control get_password" placeholder="<?php esc_html_e('Email', 'workreap'); ?>">
								</div>
								<?php if( isset( $captcha_settings ) && $captcha_settings === 'enable' ) {?>
									<div class="domain-captcha form-group">
								...
								<div class="wt-logininfo">
									<a href="javascript:;" class="wt-btn do-get-password-btn"><?php esc_html_e('Get Password','workreap');?></a>
								</div> 
						...
						<div class="modal-footer">
							...
							<div class="wt-loginfooterinfo">
								<a href="javascript:;" class="wt-registration-poup"><em><?php esc_html_e('Not a member?','workreap');?></em>&nbsp;<?php esc_html_e('Signup Now','workreap');?></a>
								<a href="javascript:;" class="wt-forgot-password wt-show-login2"><?php esc_html_e('Reset Password?','workreap');?></a>
							</div>
						 </div>
					</div>
				</div>
        ...
        public function workreap_prepare_search_formv3($header_key='header_v3') {
            ...
            if( !empty($searchs) ) {?>
				<div class="wt-headersearch">
					<a href="javascript:;" class="wt-headerbtn"><i class="ti-search"></i></a>
				...
				<form class="wt-formtheme wt-formbanner wt-formbannervtwo" action="<?php echo esc_url($defult_url);?>" method="get">
					<fieldset>
								...
								<?php if( !empty($searchs) ) {?>
									...
									<div class="wt-radioholder">
										<?php 
											...
											?>
											<span class="wt-radio">
												<input id="wtheader-<?php echo esc_attr( $search );?>" data-url="<?php echo esc_url($action_url);?>" data-title="<?php echo esc_attr( $list_names[$search]);?>" type="radio" name="searchtype" value="<?php echo esc_attr($search);?>" <?php echo esc_attr($checked);?>>
												<label for="wtheader-<?php echo esc_attr( $search );?>"><?php echo esc_html( $list_names[$search]);?></label>
											</span>
										<?php } ?>
									</div>
								<?php } ?>
                        ...
                        <div class="wt-btn-remove-holder">
                            <a href="javascript:;" class="wt-search-remove"><?php esc_html_e('Cancel','workreap');?></a>
