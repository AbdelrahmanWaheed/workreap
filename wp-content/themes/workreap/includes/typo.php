...
if (!function_exists('workreap_add_dynamic_styles')) {
    ...
    function workreap_add_dynamic_styles() {
        if (function_exists('fw_get_db_settings_option')) {
			...
			$nrf_users 		= fw_get_db_settings_option('nrf_users');
        }
        ...
        if (isset($color_base['gadget']) && $color_base['gadget'] === 'custom') {
            if (!empty($color_base['custom']['primary_color']) 
				...
				$theme_rgb_color 	 = !empty( $color_base['custom']['primary_rgb_color'] ) ? $color_base['custom']['primary_rgb_color'] : '';
				$secondary_rgb_color = !empty( $color_base['custom']['secondary_rgb_color'] ) ? $color_base['custom']['secondary_rgb_color'] : '';
				$tertiary_rgb_color  = !empty( $color_base['custom']['tertiary_rgb_color'] ) ? $color_base['custom']['tertiary_rgb_color'] : '';
				...
				<?php if(!empty( $tertiary_color )){?>
          		...
          		<?php if(!empty($secondary_rgb_color) && $tertiary_rgb_color){?>
          			.wt-home-slider:after,
					.wt-bannerholdervthree:before{
						background: -webkit-linear-gradient(left,<?php echo esc_html($secondary_rgb_color);?>,<?php echo esc_html($tertiary_rgb_color);?> 100%);
						background: linear-gradient(to right,<?php echo esc_html($secondary_rgb_color);?> ,<?php echo esc_html($tertiary_rgb_color);?> 100%);
					}
				<?php
				}
			} 
